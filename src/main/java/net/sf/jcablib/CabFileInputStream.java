...
extends InputStream {
    ...
    */
    CabFileInputStream(CabEntry ce)
    throws IOException {
    ...
    * @exception IOException thrown by various file IO routines
    */
    public CabFileInputStream(CabFolder cf)
    throws IOException {
    ...
    */
    ...
    /**
    * Reads cab file entry into an array of bytes. This method will
    ...
    * @exception CabException if a Cabinet format error has occurred
